...
FROM HOL_COCO_CWORK.DATA.FACT_ITEM_SALES f
JOIN HOL_COCO_CWORK.DATA.DIM_STORE s ON f.STORE_ID = s.STORE_ID
{WHERE_CLAUSE};
```
...
FROM HOL_COCO_CWORK.DATA.FACT_ITEM_SALES f
JOIN HOL_COCO_CWORK.DATA.DIM_STORE s ON f.STORE_ID = s.STORE_ID
JOIN HOL_COCO_CWORK.DATA.DIM_ITEM i ON f.ITEM_ID = i.ITEM_ID
{WHERE_CLAUSE}
